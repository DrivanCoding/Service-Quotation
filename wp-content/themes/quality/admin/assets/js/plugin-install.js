jQuery(document).ready(function($) {
    'use strict';
    var this_obj = quality_companion_install;
    ...
    $(document).on('click', '.webriti-customizer-notification-dismiss', function(event) {
        ...
        var sdata = {};
        if(slug){
            sdata.action = 'quality_hide_customizer_notice';
            sdata.quality_plugin_slug = slug;
        }else{
            sdata.action = 'quality_hide_customizer_companion_notice';
        }
