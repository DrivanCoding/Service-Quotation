<div class="h-column h-column-container d-flex h-col-lg-12 h-col-md-12 h-col-12  masonry-item style-140-outer style-local-25-m3-outer">
  <div data-colibri-id="25-m3" class="d-flex h-flex-basis h-column__inner h-px-lg-0 h-px-md-0 h-px-0 v-inner-lg-0 v-inner-md-0 v-inner-0 style-140 style-local-25-m3 position-relative">
    <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
      <div data-colibri-id="25-m4" class="h-row-container gutters-row-lg-2 gutters-row-md-2 gutters-row-2 gutters-row-v-lg-2 gutters-row-v-md-2 gutters-row-v-2 style-806 style-local-25-m4 position-relative">
        <div class="h-row justify-content-lg-center justify-content-md-center justify-content-center align-items-lg-stretch align-items-md-stretch align-items-stretch gutters-col-lg-2 gutters-col-md-2 gutters-col-2 gutters-col-v-lg-2 gutters-col-v-md-2 gutters-col-v-2">
          <div class="h-column h-column-container d-flex h-col-lg-auto h-col-md-auto h-col-auto style-807-outer style-local-25-m5-outer">
            <div data-colibri-id="25-m5" class="d-flex h-flex-basis h-column__inner h-px-lg-0 h-px-md-0 h-px-0 v-inner-lg-0 v-inner-md-0 v-inner-0 style-807 style-local-25-m5 position-relative">
              <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
                <div data-href="<?php the_permalink(); ?>" data-colibri-component="link" data-colibri-id="25-m6" class="colibri-post-thumbnail <?php althea_wp_post_thumbnail_classes(); ?> <?php althea_wp_post_thumb_placeholder_classes(); ?> style-809 style-local-25-m6 h-overflow-hidden position-relative h-element">
                  <div class="h-global-transition-all colibri-post-thumbnail-shortcode style-dynamic-25-m6-height">
          ...
          <div class="h-column h-column-container d-flex h-col-lg-auto h-col-md-auto h-col-auto style-808-outer style-local-25-m10-outer">
            <div data-colibri-id="25-m10" class="d-flex h-flex-basis h-column__inner h-px-lg-0 h-px-md-0 h-px-0 v-inner-lg-0 v-inner-md-0 v-inner-0 style-808 style-local-25-m10 position-relative">
              <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
                <?php if ( \ColibriWP\Theme\Core\Hooks::prefixed_apply_filters( 'show_post_meta', true ) ): ?>
                <div data-colibri-id="25-m11" class="h-blog-meta style-115 style-local-25-m11 position-relative h-element">
                ...
                <?php endif; ?>
                <div data-colibri-id="25-m12" class="h-blog-title style-144 style-local-25-m12 position-relative h-element">
                ...
                <div data-colibri-id="25-m14" class="h-x-container style-147 style-local-25-m14 position-relative h-element">
                  <div class="h-x-container-inner style-dynamic-25-m14-group">
                    <span class="h-button__outer style-123-outer style-local-25-m15-outer d-inline-flex h-element">
                      <a h-use-smooth-scroll="true" href="<?php the_permalink(); ?>" data-colibri-id="25-m15" class="d-flex w-100 align-items-center h-button justify-content-lg-center justify-content-md-center justify-content-center style-123 style-local-25-m15 position-relative">
                        <span>
