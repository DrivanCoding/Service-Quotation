        ...
        <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
          <div data-colibri-id="16-m20" class="post-nav-button hide-title style-91 style-local-16-m20 position-relative h-element">
            <div class="h-global-transition-all">
              <?php althea_wp_post_nav_button(array (
                'type' => 'prev',
                'prev_post' => __('Previous article', 'althea-wp'),
                'next_post' => __('Next post:', 'althea-wp'),
                'show_title' => false,
                'title_length' => 40,
              )); ?>
            </div>
        ...
        <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
          <div data-colibri-id="16-m22" class="post-nav-button hide-title style-93 style-local-16-m22 position-relative h-element">
            <div class="h-global-transition-all">
              <?php althea_wp_post_nav_button(array (
                'type' => 'next',
                'prev_post' => __('Previous post:', 'althea-wp'),
                'next_post' => __('Next article', 'althea-wp'),
                'show_title' => false,
                'title_length' => 30,
              )); ?>
            </div>
