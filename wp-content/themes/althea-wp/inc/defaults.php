<?php
	...
	$althea_wp_theme_click_pen_to_edit_title = __( '<span style="font-size: 53%; font-weight: 300;">Don\'t wait for the opportunity.</span><br>CREATE IT!',
		'althea-wp' );

	if ( apply_filters( 'colibri_page_builder/installed', false ) ) {
		$althea_wp_theme_click_pen_to_edit_title = __( 'Just click and start typing to change the site headline.',
			'althea-wp' );
	}

	$althea_wp_theme_action_button = __( 'Action Button %d', 'althea-wp' );
	...
	return array(
		...
		'edit_this_text_in_customizer'      => $althea_wp_theme_click_pen_to_edit_title,
		...
		'header_front_page'                 => array(
			...
			"title"        => array(
				"show"  => true,
				"value" => $althea_wp_theme_click_pen_to_edit_title,
				"style" => array(
					"textAlign" => "left"
				),
			),
