			...
			<div class="four-columns-wrap getting-started">
				...
				<div class="column-width-4 bard-woocommerce-inst-box">
					...
					<p>
						...
						echo wp_kses( 'With Bard theme you can build a beautiful <a style="color: #3858E9;" href="https://wp-royal.com/themes/bard-free/demo/shop/?ref=ashe-free-backend-about-shop-prev-bt" target="_blank">online shop</a> with ease, just install the Woocommerce plugin and start building your shop today!', $allowed_html); ?>
					</p>
					...
					<?php endif; ?>
					<a style="width: 215px; display: block" href="<?php echo esc_url('https://wp-royal.com/video-tutorial-coming-soon/') ?>" target="_blank" class="button button-primary import-video"><span class="dashicons dashicons-video-alt3"></span><?php esc_html_e( 'Shop Setup Video Tutorial', 'bard' ); ?></a>
				</div>
