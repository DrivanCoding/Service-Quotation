...
// Footer copyright section
    function quality_blue_copyright_customizer($wp_customize)
    {
        $wp_customize->add_section(
            ...
            array(
            'title' => esc_html__('Footer Copyright Setting', 'quality-blue'),
            'priority' => 1100,
        ...
        $wp_customize->add_setting(
         ...
         'default' => '<p>'.__('Proudly powered by <a href="https://wordpress.org">WordPress</a> | Theme: <a href="https://webriti.com" rel="nofollow">Quality Blue</a> by Webriti', 'quality-blue').'</p>',
         'type' =>'option',
        ...
        $wp_customize->add_control(
            'quality_pro_options[footer_copyright_text]',
            array(
        'label' => esc_html__('Copyright Text', 'quality-blue'),
