...
<div class="content_item " id="option_detaille">  
    ...
    <div class="option">
      ...
      <span class="option_value" id="securiter" name="securiter"> </span>             
        ...
        <div class="content_item "> 
        <div class="request_item"><h3 id="devis"></h3> </div><br>
       </div>
       <div class="client">
       <div class="infosClient">
        <div class="titre">
            <h3>Renseignier nous sur vous</h3>
        </div>
        <div class="content_item">
            <fieldset>
                <legend>Nom <font color="red">*</font></legend>
                <input class="input" type="text" placeholder="Nom" name="nomclient" id="">
            </fieldset>
            <fieldset>
                <legend>E-mail <font color="red">*</font></legend>
                <input class="input" type="email" placeholder="E-mail" name="email" id="">
            </fieldset>
        </div>
     </div>
       </div>
