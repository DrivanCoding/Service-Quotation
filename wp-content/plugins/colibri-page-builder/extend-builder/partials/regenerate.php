...
?>
			<div id="colibri_site_imported_notice" class="notice notice-success">
				...
				<div class="colibri-display-table">
					...
					<div class="colibri-display-table-cell">
						<h2><?php echo $theme_name; ?> design has been successfully imported!</h2>
						<p>Your <?php echo $theme_name; ?> design has been successfully imported! You can take a look at your
							new design
							or
